...
function CreateQuizPage() {
    ...
    const handleGenerateAndSaveQuiz = async ()=>{
        ...
        try {
            const quizGenerationData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateQuiz"])(topic, difficulty, questionCount, fileId);
            const quizToSave = {
                title: file?.name?.replace('.pdf', '') || "Untitled Quiz",
                topic: topic,
                questions: quizGenerationData.questions
            };
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveQuiz"])(quizToSave);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2204732._.js.map